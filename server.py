...
def get_samples():
    ...
    if mc.get('random_samples') is not None:
        ...
        print('MEMCACHEEEEEEEEEEEEEEEEE')
...
def get_scree_data():
    ...
    print(stratified_scree_values.shape)
...
def get_euclidean_data():
    ...
    # euclidean_values = SK_Metrics.pairwise_distances(samples, metric = 'euclidean')
...
def get_matrix_data():
    ...
    # dict['matrix_stratified'] = stratified_scree_values
    dict['labels'] = first_row
    print("sending data.....")
    return app.response_class(json.dumps(dict), content_type='application/json')
